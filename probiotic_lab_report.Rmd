...
-   Changing text colour \textcolor{red}{red}
...
```{r,echo =FALSE, eval=TRUE, fig.cap="Your Figure Caption", fig.align = "center", fig.width = 8, fig.height= 10, out.width = "87%"}
...
model_3_summary %>% 
kbl(caption="Linear Regresion Summary of Difference by Gender and Group", digits = 2) %>%
  kable_styling(bootstrap_options = "striped", full_width = T)
```

```{r, echo = F ,eval=T, fig.align = "center", fig.width = 10.7, fig.height= 9.5, out.width = "83%"}  
